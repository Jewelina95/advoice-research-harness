...
def _config_files(p: ProjectPaths, dataset_id: str) -> dict[str, Path]:
    return {
        ...
        "correlation_families": p.configs / "states" / "correlation_families.yaml",
    ...
    stages.append(
        cache.execute(
            ...
            [
                ...
                output["segments"],
                config_paths["states"],
                config_paths["correlation_families"],
                config_paths["channel"],
                configs["states"],
                _source(p, "states.py"),
                _source(p, "state_graph.py"),
                "state-graph-family-budget-task-residual-v1",
            ],
    ...
    stages.append(
        cache.execute(
            ...
            [
                ...
                _source(p, "calibration_training.py"),
                _source(p, "states.py"),
            ...
            [
                ...
                output["agent_calibration_workspaces"],
                {
                    ...
                    for key in [
                        ...
                        "diagnostic_agent_log_loss_noninferiority_margin",
                        "diagnostic_agent_brier_noninferiority_margin",
                    ]
                },
                _source(p, "cognitive_agent.py"),
                _source(p, "evidence_review.py"),
                _source(p, "diagnostic_agent.py"),
